...
class EchartFunnelCustomViz(BaseViz):
    viz_type = 'echarts_funnel_customized'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartFunnelCustomViz, self).query_obj()
        fd = self.form_data
...
class EchartsLineAreaStack(BaseViz):
    viz_type = 'echarts_line_area_stack'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsLineAreaStack, self).query_obj()
        fd = self.form_data
...
class EchartsLineRain(BaseViz):
    viz_type = 'echarts_line_rainfall'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsLineRain, self).query_obj()
        fd = self.form_data
...
class EchartsLineDiffAxis(EchartsLineRain):
    viz_type = 'echarts_line_diff_axis'
    is_timeseries = False



class EchartsBarPolar(BaseViz):
    viz_type = 'echarts_bar_polar'
    is_timeseries = False
...
class EchartsBarAniamtionViz(BaseViz):
    viz_type = 'echarts_bar_animation'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsBarAniamtionViz, self).query_obj()
        fd = self.form_data
...
class EchartsBarMinusViz(BaseViz):
    viz_type = 'echarts_bar_minus'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsBarMinusViz, self).query_obj()
        fd = self.form_data
...
class EchartsScatterExpRegViz(BaseViz):
    viz_type = 'echarts_scatter_exp_reg'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsScatterExpRegViz, self).query_obj()
        fd = self.form_data
...
class EchartsScatterMapViz(BaseViz):
    viz_type = 'echarts_scatter_map'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsScatterMapViz, self).query_obj()
        fd = self.form_data
...
class EchartsScatterSquViz(BaseViz):
    viz_type = 'echarts_scatter_squ'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsScatterSquViz, self).query_obj()
        fd = self.form_data
...
class EchartsScatterBasicViz(BaseViz):
    viz_type = 'echarts_scatter_basic'
    is_timeseries = False

    def query_obj(self):
        form_data = self.form_data
        d = super(EchartsScatterBasicViz, self).query_obj()
        d['groupby'] = [
...
class EchartsMapBasic(BaseViz):
    viz_type = 'echarts_map_basic'
    is_timeseries = False
...
class EchartsGraphExpentency(BaseViz):
    viz_type = 'echarts_graph_expentency'
    is_timeseries = False
    ...
    def query_obj(self):
        d = super(EchartsGraphExpentency, self).query_obj()
        fd = self.form_data

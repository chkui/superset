...
class DemandStatusView(SupersetModelView, DeleteMixin):
    datamodel = SQLAInterface(models.DemandStatus)
...
class DemandModelView(SupersetModelView, DeleteMixin):
    datamodel = SQLAInterface(models.DemandTemplate)
    show_columns = ['title', 'category', 'field_list', 'desc_text', 'attach_path', 'author', 'create_time',
                    'last_edit_time', 'handle_begin_time', 'handle_end_time', 'handler', 'status']
    list_columns = ['title', 'category','author', 'handle_begin_time', 'handle_end_time', 'handler', 'status']
    edit_columns = ['title', 'category', 'field_list', 'desc_text', 'attach_path', 'author', 'create_time',
                    'last_edit_time', 'handle_begin_time', 'handle_end_time', 'handler', 'status']
    add_columns = ['title', 'category', 'field_list', 'desc_text', 'create_time', 'author']
    label_columns = {
        'title': _('需求名称'),
        'category': _('部门名称'),
        'field_list': _('字段列表'),
        'desc_text': _('详细描述'),
        'attach_path': _('附件存储路径'),
        'author': _('提交人'),
        'create_time': _('需求提交时间'),
        'last_edit_time': _('最近更新时间'),
        'handle_begin_time': _('处理开始时间'),
        'handle_end_time': _('预计处理结束时间'),
        'handler': _('处理人'),
        'status': _('状态')
    }


class DemandAsyncModelView(DemandModelView):
    list_columns = ['title', 'category', 'field_list', 'desc_text', 'create_time', 'last_edit_time',
                    'handle_begin_time', 'handle_end_time']


class DepartmentModelView(SupersetModelView, DeleteMixin):
    datamodel = SQLAInterface(models.DepartmentTemplateView)
    show_columns = ['id', 'depart_name']
    list_columns = ['id', 'depart_name']
    edit_columns = ['depart_name']
    add_columns = ['depart_name']
...
appbuilder.add_view(
    ...
    icon='fa-list',
    category='Demand',
    category_label=__('需求反馈'),
    category_icon='fa-h-square')
...
appbuilder.add_view_no_menu(DemandAsyncModelView)
# ---------------------------------------------------------------------

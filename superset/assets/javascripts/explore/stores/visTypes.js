...
export const visTypes = {
    ...
    echarts_funnel_customized: {
        label: t('Echarts Funnel Custom'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_line_area_stack: {
        label: t('Line Area Stack'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_line_rainfall: {
        label: t('Line RainFall'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_line_diff_axis: {
        label: t('Line Diff Axis'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_bar_animation: {
        label: t('Bar Aniamtion'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_scatter_exp_reg: {
        label: t('Scatter Exponential Regression'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
    ...
    echarts_scatter_basic: {
        label: t('Scatter Bubble'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('Query'),
    ...
    echarts_graph_expentency: {
        label: t('Graph Expentency'),
        showOnExplore: true,
        controlPanelSections: [
            {
                label: t('GROUP BY'),
